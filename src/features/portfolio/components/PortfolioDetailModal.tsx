...
import { toSafeHttpUrl } from "@/server/lib/safe-url";
import { getYouTubeEmbedUrl } from "@/features/portfolio/lib/youtube";
        ...
        externalLinkUrl ? (
          <a
            ...
            rel="noopener noreferrer"
                        className="neo-icon group/link size-8 overflow-hidden p-1 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2"
            ...
            {items.length > 1 && (
              <div className="flex items-center gap-2 shrink-0">
                <button
                  onClick={goPrev}
                  disabled={!hasPrev}
                  className="neo-icon size-10 disabled:pointer-events-none disabled:opacity-30"
